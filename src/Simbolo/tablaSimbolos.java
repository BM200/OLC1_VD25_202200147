...
public class tablaSimbolos {
    ...
    public java.util.LinkedList<Simbolo> getVariables() {
        java.util.LinkedList<Simbolo> lista = new java.util.LinkedList<>();
        
        // Recorremos todos los valores guardados en el entorno actual
        for (Object valor : this.tablaActual.values()) {
            // Validamos que sea un Simbolo antes de agregarlo
